                ...
                <div class="panel-body">
                    ...
                    <form action="{{ url('task')}}" method="POST" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="email" id="task-name" class="form-control" value="{{ old('task') }}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="address" id="task-name" class="form-control" value="{{ old('task') }}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="phno" id="task-name" class="form-control" value="{{ old('task') }}">
                            </div>
                        </div>
                            ...
                            <tbody>
                                @foreach ($tasks as $task)
                                    <tr>
                                        ...
                                        <td class="table-text"><div>{{ $task->phno }}</div></td>
                                        <td>
                                            <form action="{{ url('updateinfo/'.$task->id) }}" method="GET">
                                                {{ csrf_field() }}
